...
//    private Octahedron MyOctahedron = new Octahedron(); //原点に，外接球半径１の立方体オブジェクトを作成
    private Tetrahedron MyTetrahedron = new Tetrahedron(); //原点に，外接球半径１の立方体オブジェクトを作成
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        //MyOctahedron.draw(0f, 1f, 0f, 1f, 20.f);
